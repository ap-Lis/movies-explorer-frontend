        ...
        <main className="register">
            ...
            <form name="register" className="register__form" onSubmit={handleSubmit} noValidate>
                <label className = "register__field">Имя
                    <input className={`register__input ${handleNameValidation() && `register__input_color_red`}`} onChange={e => name.onChange(e)} onBlur={e => name.onBlur(e)} type="name" name="name" id="name-input"/>
                </label>
                <label className = "register__field">E-mail
                    <input className={`register__input ${handleEmailValidation() && `register__input_color_red`}`} onChange={e => email.onChange(e)} onBlur={e => email.onBlur(e)} type="email" name="email" id="email-input"/>
                </label>
                <label className = "register__field">Пароль
                    <input className={`register__input ${handlePasswordValidation() && `register__input_color_red`}`} onChange={e => password.onChange(e)} onBlur={e => password.onBlur(e)} type="password" name="password" id="password-input"/>
